...
| 3 | **Execution** | implementation-instructions → code that passes the gate | commits (the diff) | Claude subagents (in-ecosystem dogfooding); cheap path: opencode + north-mini |
...
**context-budget principle: broad at the top, narrow at the executor** — the
